                    ...
                    <div className='flex-1 flex-col text-start'>
                        ...
                        <div className='flex flex-row'>
                            {menus.alergens.map((alerg) =>
                                <p className='label-emerald text-xs rounded-sm px-1 mr-2'>{alerg}</p>
                            )}
                        </div>
                    </div>

                    <div className='flex items-center'>
                        <button key={menus.id} className='button-red rounded-lg ml-10 w-24 h-8 mr-4' onClick={() => deleteMenu(menus.id)}>Eliminar</button>
                        <button key={menus.id + 'edit'} className='button-sky rounded-lg ml-2 w-24 h-8 mr-4' onClick={() => editMenu(menus.id)}>Editar</button>
