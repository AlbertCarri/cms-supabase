                                    ...
                                    <div>
                                        <div className="flex flex-row justify-center">
                                            ...
                                            <div className="basis-96">
                                                <p className='text-md mb-2 underline underline-offset-4'>{category_menu.name}</p>
                                                <p className='text-xs mb-1 h-16'>{category_menu.description}</p>
                                        ...
                                        < div className='flex flex-row justify-center' >
                                            {category_menu.alergens.map((alerg) =>
                                                <p className='label-emerald text-xs line-clamp-1 md:line-clamp-none rounded-sm px-1 mr-2 mb-4'>{alerg}</p>
                                            )}
                                        </div>
