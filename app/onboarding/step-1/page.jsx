    ...
    <div className="w-11/12 md:w-2/3 bg-slate-800 mx-auto p-8 rounded-lg">
      <form action={sendingStep1} className="flex flex-col p-4">
        ...
        <label htmlFor="direccion" className="p-2 mt-8">
          Ubicación:<span className="text-cyan-300 italic"> (puedes completarlo después)</span>
        </label>
        <input
          className="text-black p-2 rounded-md"
          id="direccion"
        ...
        />
        <p className="p-2 mt-8">Horarios:<span className="text-cyan-300 italic"> (puedes completarlo después)</span></p>
        {weekDays.map((day) => (
        ...
        <div className="flex flex-col w-2/3 mt-8">
          <label htmlFor="redsocial">Seleccione una red social: <span className="text-cyan-300 italic"> (puedes completarlo después)</span></label>
          <select
            name="redsocial"
            id="redsocial"
            value=""
